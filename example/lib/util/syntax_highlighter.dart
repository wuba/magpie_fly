...
class SyntaxHighlighterStyle {
  ...
  static SyntaxHighlighterStyle magpieDarkThemeStyle() {
    return SyntaxHighlighterStyle(
        baseStyle: const TextStyle(color: Color(0xFFFFFFFFF)),
        numberStyle: const TextStyle(color: Color.fromRGBO(168, 92, 255, 1)),
        commentStyle: const TextStyle(color: Color(0xFF9E9E9E)),
        keywordStyle: const TextStyle(color: Color.fromRGBO(255, 0, 94, 1)),
        stringStyle: const TextStyle(color: Color.fromRGBO(255, 215, 79, 1)),
        punctuationStyle: const TextStyle(color: Color(0xFFFFFFFF)),
        classStyle: const TextStyle(color: Color.fromRGBO(39, 213, 238, 1)),
        constantStyle: const TextStyle(color: Color.fromRGBO(39, 213, 238, 1)));
  }
